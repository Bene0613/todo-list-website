...
.around { max-width: 600px; margin: 0 auto; }
.list { background-color: #212A39; padding: 15px; margin: 10px 0; border-radius: 8px; box-shadow: inset 0 0 5px #000; }
.list a { text-decoration: none; color: aquamarine; font-weight: bold; }
.list a:hover { text-decoration: underline; }
form { display: flex; justify-content: center; margin-top: 20px; }
form input[type="text"] { padding: 10px; border-radius: 5px; border: none; background: #212A39; color: aliceblue; margin-right: 10px; }
form input[type="submit"] { background-color: #5C6B7D; border: none; border-radius: 5px; padding: 10px 15px; cursor: pointer; color: aliceblue; }
form input[type="submit"]:hover { background-color: aquamarine; color: #353F4D; }
.logout { text-align: center; margin-top: 30px; }
.logout a { color: pink; text-decoration: none; }
